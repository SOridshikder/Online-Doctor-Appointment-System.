<!DOCTYPE html>
<html>
<body style="background-image:url(images/p7.jpg)">
<link rel="stylesheet" href="main.css">
			...
			<div class="center">
				<h1>Doctor Consultation System</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%"></p><br>
				<li><a onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:93%;left:33%;background-color:black">Log In as User</a></li>
				
			</div>	
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					<li><a href="admin/alogin.php">Log In as Admin</a></li>
					<li><a href="admin/mlogin.php">Log In as Manager</a></li>
				</ul>
			</div>
