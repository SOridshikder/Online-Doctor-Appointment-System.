...
<body style="background-image:url(locate.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> Doctor </strong> Consultation System</a></li>
	...
	<div class="sucontainer" style="background-image:url(locate.jpg)">
		<ul style="background-image:url(locate.jpg)">			
